...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">School Management System</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To School Management System</h1>
			<!-- Icon Divider-->
...
<section class="d-flex justify-content-center align-items-center">
    ...
    <div class="p-4 bg-white shadow-lg w-50">
        <h3 class="text-center mb-4">Certificate Generator</h3>
        <form action="DownloadDataServlet" method="get">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="school" id="school" class="form-control" placeholder="School Name" required>
            </div>
            <div class="mb-3">
                <label for="certificate_type"><i class="zmdi zmdi-file"></i></label> 
            ...
            <div class="d-grid">
                <button class="btn btn-secondary btn-lg mt-4" type="submit">Generate Certificate</button>
            </div>
        </form>
    </div>
</section>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead"><span class="text-secondary fw-bold ">Innoovatum's Mission is to</span>
								Make Engineering Education a Practical Approach
								</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">To motivate, inspire, assist, and support aspiring engineers to 
					come up with new innovative ideas as well as successfully implement them. 
					Our goal is to produce next generation of pioneering engineers who will change the world 
					with their great vision. If you have an idea, big or small, we can help you! 
					Come join us, as we are here to bring your vision to life!</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-secondary"
					href="https://innoovatum.com/"> <i
					class="zmdi zmdi-globe-alt "></i>Innoovatum.com
				</a>
			</div>
		</div>
	</section>
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								...
								For more info contact us <br /> <a
									href="https://innoovatum.com/">Innoovatum.com</a>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Building, D-Block, BLDEA Engineering College College, 
						Classroom Complex, 1st floor, Asharam Road  <br /> Vijayapura, Karnataka 586103
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="text-uppercase mb-4">Around the Web</h4>
					<a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/innoovatum1/"><i
						class="fab fa-fw fa-facebook-f"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="#!"><i
						class="fab fa-fw fa-twitter"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/company/innoovatum/"><i
						class="fab fa-fw fa-linkedin-in"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/innoovatum/"><i
